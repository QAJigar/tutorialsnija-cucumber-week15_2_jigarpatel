...
public class LoginPage extends Utility {
    ...
    public void enterTextToEmailAddress(String emailText) {
        sendTextToElement(emailAddress, emailText);
        log.info("Enter email address: " + emailText + emailAddress.toString());
    }
